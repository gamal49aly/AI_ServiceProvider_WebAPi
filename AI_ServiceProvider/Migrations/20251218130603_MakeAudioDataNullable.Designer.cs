...
namespace AI_ServiceProvider.Migrations
{
    ...
    [Migration("20251218130603_MakeAudioDataNullable")]
    partial class MakeAudioDataNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TextToSpeechInput", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TextToSpeechOutput", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TextToSpeechOutput", b =>
                {
                    b.HasOne("TextToSpeechInput", "Input")
                        .WithOne("Output")
                        .HasForeignKey("TextToSpeechOutput", "InputId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
